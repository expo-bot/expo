...
- [iOS] Fixed prop and bounds updates that don't change the source cancelling and restarting the image request, which prevented images from loading while an unrelated prop such as `opacity` was animated.
